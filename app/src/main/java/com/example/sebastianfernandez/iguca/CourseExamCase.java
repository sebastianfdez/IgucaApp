...
public class CourseExamCase extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener,
        OnPageErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_course_exam_case );
        ...
        pdfView = (PDFView) findViewById(R.id.courseExamCasePdfView);
        ...
        pdfName = "Caso examen " + getSharedPreferences ( "myPref", Context.MODE_PRIVATE).getString ("CourseName" + i,"");

        pdfView.fromFile (new File ( "/data/data/com.example.sebastianfernandez.iguca/cache/Examen/" + courseKey + ".pdf" ) )
